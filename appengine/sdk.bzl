...
load(":variables.bzl", "APPENGINE_VERSION", "CLOUD_SDK_PLATFORM_ARCHIVE", "CLOUD_SDK_PLATFORM_SHA256", "SDK_URL_PREFIX")
...
def appengine_repositories():
    appengine_download_cloud_sdk(
        name = "com_google_cloud_sdk",
    )
